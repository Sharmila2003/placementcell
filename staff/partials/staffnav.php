<?php
    ...
    $staff_email=$_SESSION['emailid'];
    $sql ="SELECT * FROM users WHERE emailid='$staff_email'";
...
<link href="https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@1,900&family=Roboto&family=Rubik:ital,wght@1,900&family=Ubuntu:ital,wght@1,300&display=swap" rel="stylesheet">
        ...
        <title>Placement Cell | Staff</title>
    ...
    <body id="body-pd" class="body-pd">
        <header class="header body-pd" id="header">
            <div class="header__toggle ">
             ...
             <div class="mt-3">
                <h4>Welcome <?php echo $staff_firstname.' '.$staff_lastname?></h4>    
            </div>
        </header>
            ...
            <nav class="nav" style="overflow-y:auto">
                <div>
                    <a class="nav__logo">
                        ...
                        <span class="nav__logo-name">Staff</span>
                    </a>

                    <div id= "left-nav" class="nav__list admin_nav_list">
                        <a href="../staff/dashboard.php" class="nav__link admin_nav_link">
                        <i class='bx bx-grid-alt nav__icon' ></i>
                            <span class="nav__name">Dashboard</span>
                        </a>

                        <a href="../staff/viewcompany.php" class="nav__link admin_nav_link">
                        <i class='bx bxs-user-detail'></i>
                            <span class="nav__name">Company</span>
                        </a>

                        <a href="../staff/viewplacementdetails.php" class="nav__link admin_nav_link">
