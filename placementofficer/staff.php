...
$query="select * from users where roles='Staff'";
  ...
  <section id="minimal-statistics">
    <div class="row">
      <div class="col-12 mt-3 mb-1">
        <h4 class="text-uppercase mt-3" style="color:#4649FF;font-family: 'Noto Serif Ahom', serif;font-size:45px;">ADD Staff</h4>
      </div>
    </div>
  ...
  <td>
    <div class="d-flex">
      <form method="POST" action='partials/db_action.php'>
        <input type='hidden' name='id' value='<?php echo $row['id'] ?>'/><a href="staff.php?id=<?php echo $row['id']?>" name='staff_edit' class="px-3 btn btn-primary btn-sm">Edit</a>
      </form>
      <form method="POST" action='partials/db_action.php'>
        <input type='hidden' name='id' value='<?php echo $row['id'] ?>'/>
        <?php
        echo "<input  class='btn btn-danger ml-2 btn-sm' type='submit' style='outline:none;' onclick='return Delete_staff();' name='staff_delete' value='Delete' />";?>
        </form>
      </div>   
  </td>
</tr>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add Staff Detail</h5>
      ...
      <div class="modal-body">
        <form action="partials/db_action.php" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" value="Staff" name="role" id="exampleInputEmail1" aria-describedby="emailHelp" readonly>
          </div>
